...
::: details
```
[root@localhost ansible-lnmp-main]# netstat -a | more //列出所有端口
...
[root@localhost ansible-lnmp-main]# netstat -at //列出所有 tcp 端口 
Active Internet connections (servers and established)
Proto Recv-Q Send-Q Local Address           Foreign Address         State      
tcp        0      0 0.0.0.0:zabbix-agent    0.0.0.0:*               LISTEN     
tcp        0      0 localhost:cslistener    0.0.0.0:*               LISTEN     
...
tcp6       0      0 [::]:ssh                [::]:*                  LISTEN     
tcp6       0      0 localhost:smtp          [::]:*                  LISTEN     
[root@localhost ansible-lnmp-main]# netstat -au //列出所有 udp 端口 
Active Internet connections (servers and established)
Proto Recv-Q Send-Q Local Address           Foreign Address         State      
[root@localhost ansible-lnmp-main]# 
[root@localhost ansible-lnmp-main]# netstat -l //只显示监听端口 
...
tcp6       0      0 [::]:http               [::]:*                  LISTEN     
tcp6       0      0 [::]:ssh                [::]:*                  LISTEN     
[root@localhost ansible-lnmp-main]# netstat -lt //只列出所有监听 tcp 端口 
Active Internet connections (only servers)
Proto Recv-Q Send-Q Local Address           Foreign Address         State      
tcp        0      0 0.0.0.0:zabbix-agent    0.0.0.0:*               LISTEN     
tcp        0      0 localhost:cslistener    0.0.0.0:*               LISTEN     
...
tcp6       0      0 [::]:ssh                [::]:*                  LISTEN     
tcp6       0      0 localhost:smtp          [::]:*                  LISTEN     
[root@localhost ansible-lnmp-main]# netstat -lu //只列出所有监听 udp 端口
Active Internet connections (only servers)
Proto Recv-Q Send-Q Local Address           Foreign Address         State      
[root@localhost ansible-lnmp-main]# netstat -lx //只列出所有监听 UNIX 端口 
...
[root@localhost ansible-lnmp-main]# netstat -s //显示所有端口的统计信息
Ip:
