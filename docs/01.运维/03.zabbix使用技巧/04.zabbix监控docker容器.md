---
title: zabbix监控docker容器
date: 2020-10-14 11:53:30
permalink: /pages/17f935/
categories:
  - 运维
  - zabbix使用技巧
tags:
...
> 实现效果:
![](https://cdn.jsdelivr.net/gh/summerking1/image@main/21.png)

1. 编辑conf配置键值
```shell
[root@elx smartmining]# cd /etc/zabbix/zabbix_agentd.d
...
UserParameter=docker.discovery,/home/smartmining/docker.py
UserParameter=docker.[*],/home/smartmining/docker.py $1 $2
```
**注意执行权限和所属用户组，注意重启agent**

2. 导入模板后创建监控项
   ![](https://cdn.jsdelivr.net/gh/summerking1/image@main/22.png)
