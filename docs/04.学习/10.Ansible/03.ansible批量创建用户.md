---
title: ansible批量创建用户
date: 2020-12-23 15:34:39
permalink: /pages/182d53/
categories:
  - 学习
  - Ansible
tags:
...
1. 创建带加密码summer用户
```shell
[root@localhost ansible]# ansilbe redis -m  user  -a   'name=summer  shell=/bin/bash  password=$6$rounds=656000$fkskseDMlRAr7..8$./zCF2UbGiO7RrtyILeIckqK1ZU78wVwhWFeSrh2Qki604dG3apeF7BCwynu1HcnBp1g.LaFmZsjRCzJYjvzp/ update_password=always'
