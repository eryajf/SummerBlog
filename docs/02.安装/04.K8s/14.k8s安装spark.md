...
本次部署k8s-spark集群，基于kubeapps，简单便捷一步到胃
...
<a href="https://www.xswsym.online/pages/99e4ba/#%E5%9F%BA%E4%BA%8Ehelm">跳转</a>
...
```shell
[root@master home]# kubectl exec -ti sturdy-cars-spark-master-0 -n spark /bin/sh
kubectl exec [POD] [COMMAND] is DEPRECATED and will be removed in a future version. Use kubectl kubectl exec [POD] -- [COMMAND] instead.
Error from server (NotFound): namespaces "spark" not found
